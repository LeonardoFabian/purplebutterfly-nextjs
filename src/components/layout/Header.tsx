...
export const Header = () => {
  ...
  return (
    <>
      <nav className="fixed bg-white !text-primary flex items-center justify-between md:absolute w-full top-0 left-0 right-0 z-20 md:grid md:grid-cols-3 md:bg-transparent md:text-text-primary font-body py-2 px-3 md:px-6">
